...
public class Page_Order extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        {
            Intent newActivity = new Intent(Page_Order.this, MainActivity.class);
...
//                    startActivity(newActivity);
    ...
    public class ImageAdapter extends BaseAdapter
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = inflater.inflate(R.layout.page_order_column, null);
            }
            // imgCmdDelete
           cmdDelete = (Button) convertView.findViewById(R.id.btnDelete);
            //cmdDelete.setBackgroundColor(Color.TRANSPARENT);

            final AlertDialog.Builder adb1 = new AlertDialog.Builder(Page_Order.this);
            final AlertDialog.Builder adb2 = new AlertDialog.Builder(Page_Order.this);
                    ...
                    adb1.setPositiveButton("Ok", new AlertDialog.OnClickListener() {
                        public void onClick(DialogInterface dialog, int which) {
                            ...
                            if (strStatusID.equals("0")) {
                                ...
                                Toast.makeText(Page_Order.this, "Delete data successfully.",
