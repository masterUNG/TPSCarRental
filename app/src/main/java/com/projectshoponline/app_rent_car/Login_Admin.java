    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnNext.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                // Goto Activity 2
                Intent newActivity = new Intent(Login_Admin.this,MainActivity.class);
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                {
                    Toast.makeText(Login_Admin.this, "Login OK", Toast.LENGTH_SHORT).show();

                    // Create Session
                    usrHelper.createSession(strMemberID);

                    // Goto Activity2
                    Intent newActivity = new Intent(Login_Admin.this,Page_Menu_Admin.class);
                    startActivity(newActivity);
