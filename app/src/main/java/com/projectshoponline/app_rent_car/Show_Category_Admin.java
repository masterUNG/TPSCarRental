...
public class Show_Category_Admin extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.show_category_admin);
        ...
        try {
            ...
            lisView1.setOnItemClickListener(new OnItemClickListener() {
                public void onItemClick(AdapterView<?> myAdapter, View myView,
                    ...
                    Intent newActivity = new Intent(Show_Category_Admin.this,Show_All_Admin.class);
    ...
    public class ImageAdapter extends BaseAdapter
    {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = inflater.inflate(R.layout.show_category_admin_column, null);
            }
            ...
            Picasso.with(Show_Category_Admin.this)
