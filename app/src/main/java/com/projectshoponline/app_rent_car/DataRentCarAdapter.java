...
public class DataRentCarAdapter extends RecyclerView.Adapter<DataRentCarAdapter.DataRentViewHolder> {
    ...
    @Override
    public DataRentViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

        View view = layoutInflater.inflate(R.layout.recycler_view_data_rent_car, parent, false);
        DataRentViewHolder dataRentViewHolder = new DataRentViewHolder(view);

        return dataRentViewHolder;
    }

    @Override
    public void onBindViewHolder(DataRentViewHolder holder, int position) {
        ...
        String StartDateString = startdateStringArrayList.get(position);
        ...
        holder.startdateTextView.setText(StartDateString);
    ...
    public class DataRentViewHolder extends RecyclerView.ViewHolder {

        private TextView itemTextView, nameAnSurTextView, productNameTextView, startdateTextView, amountTextView;

        public DataRentViewHolder(View itemView) {
            super(itemView);
            ...
            startdateTextView = itemView.findViewById(R.id.txtStart);
